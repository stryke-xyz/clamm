...
/// @title The interface for the BulletXSwap V3 Factory
/// @notice The BulletXSwap V3 Factory facilitates creation of BulletXSwap V3 pools and control over the protocol fees
interface IBulletXV3Factory {
