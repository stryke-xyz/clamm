...
// Interfaces
import {IFusionXV3Factory} from "./v3-core/contracts/interfaces/IFusionXV3Factory.sol";
import {IFusionXV3MintCallback} from "./v3-core/contracts/interfaces/callback/IFusionXV3MintCallback.sol";
import {IFusionXV3Pool} from "./v3-core/contracts/interfaces/IFusionXV3Pool.sol";
...
abstract contract LiquidityManager is IFusionXV3MintCallback {
        ...
        returns (uint128 liquidity, uint256 amount0, uint256 amount1, IFusionXV3Pool pool)
    {
        ...
        pool = IFusionXV3Pool(computeAddress(factory, poolKey));
    ...
    function verifyCallback(address _factory, PoolKey memory poolKey) internal view returns (IFusionXV3Pool pool) {
        pool = IFusionXV3Pool(computeAddress(_factory, poolKey));
