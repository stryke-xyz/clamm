...
// Interfaces
import {IThrusterPoolFactory} from "./v3-core/contracts/interfaces/IThrusterPoolFactory.sol";
import {IThrusterMintCallback} from "./v3-core/contracts/interfaces/callback/IThrusterMintCallback.sol";
import {IThrusterPool} from "./v3-core/contracts/interfaces/IThrusterPool.sol";
...
abstract contract LiquidityManager is IThrusterMintCallback {
        ...
        returns (uint128 liquidity, uint256 amount0, uint256 amount1, IThrusterPool pool)
    {
        ...
        pool = IThrusterPool(computeAddress(factory, poolKey));
    ...
    function verifyCallback(address _factory, PoolKey memory poolKey) internal view returns (IThrusterPool pool) {
        pool = IThrusterPool(computeAddress(_factory, poolKey));
