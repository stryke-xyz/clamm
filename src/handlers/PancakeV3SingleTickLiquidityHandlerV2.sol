...
/**
 * @title PancakeV3SingleTickLiquidityHandlerV2
 * @author 0xcarrot
    ...
    LiquidityManager
{
        ...
        if (tki.totalSupply > 0) {
            ...
            if (tki.tokensOwed0 > 1_000 || tki.tokensOwed1 > 1_000) {
                ...
                if (
                    ...
                    ) = PancakeV3SingleTickLiquidityHandlerV2(address(this))
                            .addLiquidity(
                                LiquidityManager.AddLiquidityParams({
                                    token0: tki.token0,
                                    token1: tki.token1,
     ...
     * be burned and they will receive Pancake V3 fees upto this point.
     * @return The number of shares burned.
     */
     ...
     * @param _pool The PancakeV3Pool contract.
    ...
    /**
     * @notice Forcefully withdraws PancakeV3 liquidity from the given position.
     * @param pool The PancakeV3Pool to withdraw liquidity from.
