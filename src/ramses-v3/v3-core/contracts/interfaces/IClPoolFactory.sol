...
/// @title The interface for the Cl V3 Factory
/// @notice The Cl Factory facilitates creation of pools and control over the protocol fees
interface IClPoolFactory {
    ...
    /// @param sqrtPriceX96 Desired price of the pool
