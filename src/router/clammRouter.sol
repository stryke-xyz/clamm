...
contract ClammRouter is Multicall, IERC721Receiver {
    // events
    event LogMintOption(
        address user, address receiver, address optionMarket, uint256 tokenId, uint256 frontendId, uint256 referalId
    );
    ...
    function mintOption(
        ...
        IERC20(token).transferFrom(msg.sender, address(this), _params.maxCostAllowance);
        ...
        IERC721(optionMarket).transferFrom(address(this), receiver, tokenId);
