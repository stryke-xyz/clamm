...
// Interfaces
import {IPancakeV3Factory} from "./v3-core/contracts/interfaces/IPancakeV3Factory.sol";
import {IPancakeV3MintCallback} from "./v3-core/contracts/interfaces/callback/IPancakeV3MintCallback.sol";
import {IPancakeV3Pool} from "./v3-core/contracts/interfaces/IPancakeV3Pool.sol";
...
abstract contract LiquidityManager is IPancakeV3MintCallback {
        ...
        )
    {
        ...
        pool = IPancakeV3Pool(computeAddress(factory, poolKey));
    ...
    function verifyCallback(
        ...
        pool = IPancakeV3Pool(computeAddress(_factory, poolKey));
