...
contract DopexV2PositionManagerV2 is Ownable, ReentrancyGuard, Multicall {
    ...
    function reserveLiquidity(IHandler _handler, bytes calldata _reserveLiquidityData) external {
        _handler.reserveLiquidity(msg.sender, _reserveLiquidityData);
    }

    function withdrawReserveLiquidity(IHandler _handler, bytes calldata _withdrawReserveLiquidityData) external {
