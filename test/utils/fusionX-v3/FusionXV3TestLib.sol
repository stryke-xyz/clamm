...
import {FusionXV3LiquidityManagement} from "./FusionXV3LiquidityManagement.sol";
import {ERC20Mock} from "../../mocks/ERC20Mock.sol";

contract FusionXV3TestLib is Test {
    IFusionXV3Factory public immutable factory;
    FusionXV3LiquidityManagement public immutable fusionXV3LiquidityManagement;
    ...
    function deployFusionXV3PoolAndInitializePrice(address token0, address token1, uint24 fee, uint160 sqrtPriceX96)
        public
    ...
    function getCurrentSqrtPriceX96(IFusionXV3Pool pool) public view returns (uint160 sqrtPriceX96) {
        (sqrtPriceX96,,,,,,) = pool.slot0();
    }

    function getCurrentTick(IFusionXV3Pool pool) public view returns (int24 tick) {
        (, tick,,,,,) = pool.slot0();
    }
    ...
    function addLiquidity(AddLiquidityStruct memory _params) public returns (uint128 liquidity) {
        ...
        (liquidity,,,) = fusionXV3LiquidityManagement.addLiquidity(
