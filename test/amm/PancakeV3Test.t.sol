...
import {PancakeV3LiquidityManagement} from "../utils/pancake-v3/PancakeV3LiquidityManagement.sol";
...
contract PancakeV3Test is Test {
    ...
    function setUp() public {
        ...
        pool = IPancakeV3Pool(factory.createPool(address(token0), address(token1), fee));
