...
contract KodiakV3SingleTickLiquidityHarnessV3 is Test {
    ...
    constructor(
        ...
        KodiakV3SingleTickLiquidityHandlerV3 _handler
    ) {
        testLib = _testLib;
    ...
    function mintPosition(
        ...
        (lm) = positionManager.mintPosition(
            ...
            abi.encode(
                KodiakV3SingleTickLiquidityHandlerV3.MintPositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function usePosition(
        ...
        (tokens, amounts,) = positionManager.usePosition(
            IHandlerV3(address(handler)),
            abi.encode(
                KodiakV3SingleTickLiquidityHandlerV3.UsePositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function unusePosition(
        ...
        positionManager.unusePosition(
            IHandlerV3(address(handler)),
            abi.encode(
                KodiakV3SingleTickLiquidityHandlerV3.UnusePositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function donatePosition(
        ...
        (amounts,) = positionManager.donateToPosition(
            IHandlerV3(address(handler)),
            abi.encode(
                KodiakV3SingleTickLiquidityHandlerV3.DonateParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
