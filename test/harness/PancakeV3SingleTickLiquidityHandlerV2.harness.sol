...
contract PancakeV3SingleTickLiquidityHarnessV2 is Test {
    ...
    constructor(
        ...
        PancakeV3SingleTickLiquidityHandlerV2 _pcsV3Handler
    ) {
        pancakeV3TestLib = _pancakeV3TestLib;
    ...
    function mintPosition(
        ...
        (lm) = positionManager.mintPosition(
            handler,
            abi.encode(
                PancakeV3SingleTickLiquidityHandlerV2.MintPositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function usePosition(
        ...
        (tokens, amounts, ) = positionManager.usePosition(
            handler,
            abi.encode(
                PancakeV3SingleTickLiquidityHandlerV2.UsePositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function unusePosition(
        ...
        positionManager.unusePosition(
            handler,
            abi.encode(
                PancakeV3SingleTickLiquidityHandlerV2.UnusePositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
    ...
    function donatePosition(
        ...
        (amounts, ) = positionManager.donateToPosition(
            handler,
            abi.encode(
                PancakeV3SingleTickLiquidityHandlerV2.DonateParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
