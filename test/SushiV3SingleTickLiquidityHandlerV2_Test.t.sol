...
contract SushiV3SingleTickLiquidityHandlerV2_Test is Test {
    ...
    function testPutOptionSim() public {
        ...
        SushiV3SingleTickLiquidityHandlerV2.TokenIdInfo memory tki =
    ...
    function testReserveLiquidity() public {
        ...
        handler.reserveLiquidity(
            abi.encode(
                SushiV3SingleTickLiquidityHandlerV2.BurnPositionParams({
                    pool: pool,
                    hook: hook,
                    tickLower: tickLower,
                    tickUpper: tickUpper,
