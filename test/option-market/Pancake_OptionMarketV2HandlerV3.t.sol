...
contract Pancake_OptionMarketV2HandlerV3Test is Test {
    ...
    PancakeV3SingleTickLiquidityHandlerV3 handler;
    ...
    function setUp() public {
        ...
        handler = new PancakeV3SingleTickLiquidityHandlerV3(
            0x41ff9AA7e16B8B1a8a8dc4f0eFacd93D02d071c9,
            0x6ce8eb472fa82df5469c6ab6d485f17c3ad13c8cd7af59b3d4a8026c5ce0f7e2,
            address(pancakeV3TestLib.swapRouter())
        );

        positionManagerHarness = new PancakeV3SingleTickLiquidityHarnessV3(pancakeV3TestLib, positionManager, handler);
