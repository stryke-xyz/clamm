...
contract Uniswap_OptionMarketV2HandlerV3Test is Test {
    ...
    UniswapV3SingleTickLiquidityHandlerV3 handler;
    ...
    function setUp() public {
        ...
        handler = new UniswapV3SingleTickLiquidityHandlerV3(
            address(uniswapV3TestLib.factory()),
            0xa598dd2fba360510c5a8f02f44423a4468e902df5857dbce3ca162a43a3a31ff,
            address(uniswapV3TestLib.swapRouter())
        );

        positionManagerHarness = new UniswapV3SingleTickLiquidityHarnessV3(uniswapV3TestLib, positionManager, handler);
