...
contract Equalizer_OptionMarketV2Test is Test {
    ...
    function testSettleOptionCallATM() public {
        ...
        console.logInt(equalizerV3TestLib.getCurrentTick(IEqualizerV3Pool(address(pool))));
        ...
        (uint256 a0,) = LiquidityAmounts.getAmountsForLiquidity(
            equalizerV3TestLib.getCurrentTick(IEqualizerV3Pool(address(pool))).getSqrtRatioAtTick(),
