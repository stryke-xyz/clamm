...
import {PancakeV3LiquidityManagement} from "./pancake-v3-utils/PancakeV3LiquidityManagement.sol";
...
contract PancakeV3Test is Test {
    ...
    IPancakeV3Pool pool;
    uint24 fee;
    PancakeV3LiquidityManagement pancakeV3LiquidityManagement;
    ...
    function testAddingLiquidity() public {
        ...
        (uint128 liquidity, , , ) = pancakeV3LiquidityManagement.addLiquidity(
        ...
        (uint128 selfLiquidity, , , , ) = pool.positions(
            keccak256(abi.encodePacked(user, tickLower, tickUpper))
        );
    ...
    function testRemoveLiquidity() public {
        ...
        vm.stopPrank();
        (uint128 selfLiquidityAfter, , , , ) = pool.positions(
            keccak256(abi.encodePacked(user, tickLower, tickUpper))
        );
    ...
    function testSwapping() public {
        ...
        uint160 sqrtPriceX96Next = SqrtPriceMath.getNextSqrtPriceFromInput(
            sqrtPriceX96,
            liquidity,
            amountIn,
            true
        ...
        (uint160 sqrtRatioNextX96A, , uint256 amountOut, ) = SwapMath
            .computeSwapStep(
                sqrtPriceX96,
                sqrtPriceX96Next,
                liquidity,
    ...
    function testReachAParticularPrice() public {
        ...
        uint128 liquidity = pool.liquidity();
        uint256 amountIn = SqrtPriceMath.getAmount0Delta(
            sqrtPriceX96,
            targetSqrtPriceX96,
            liquidity,
            true
