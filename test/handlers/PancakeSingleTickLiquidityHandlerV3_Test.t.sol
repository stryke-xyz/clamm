...
import {PancakeV3SingleTickLiquidityHarnessV3} from "../harness/PancakeV3SingleTickLiquidityHarnessV3.sol";
import {PancakeV3SingleTickLiquidityHandlerV3} from "../../src/handlers/PancakeV3SingleTickLiquidityHandlerV3.sol";

contract PancakeSingleTickLiquidityHandlerV3_Test is Test {
    ...
    PancakeV3SingleTickLiquidityHarnessV3 positionManagerHarness;
    ...
    function setUp() public {
        ...
        pcsV3Handler = new PancakeV3SingleTickLiquidityHandlerV3(
        ...
        positionManagerHarness =
            new PancakeV3SingleTickLiquidityHarnessV3(pancakeV3TestLib, positionManager, pcsV3Handler);
    ...
    function testPutOptionSim() public {
        ...
        PancakeV3SingleTickLiquidityHandlerV3.TokenIdInfo memory tki = pcsV3Handler.getTokenIdData(
    ...
    function testReserveLiquidity() public {
        ...
        positionManager.reserveLiquidity(IHandlerV3(address(pcsV3Handler)), reserveData);
        ...
        positionManager.withdrawReserveLiquidity(IHandlerV3(address(pcsV3Handler)), reserveData);
