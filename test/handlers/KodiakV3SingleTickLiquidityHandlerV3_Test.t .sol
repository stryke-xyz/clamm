...
import {KodiakV3SingleTickLiquidityHarnessV3} from "../harness/KodiakV3SingleTickLiquidityHarnessV3.sol";
import {KodiakV3SingleTickLiquidityHandlerV3} from "../../src/handlers/KodiakV3SingleTickLiquidityHandlerV3.sol";
...
contract KodiakV3SingleTickLiquidityHandlerV3_Test is Test {
    ...
    KodiakV3SingleTickLiquidityHarnessV3 positionManagerHarness;
    KodiakV3SingleTickLiquidityHandlerV3 handler;
    ...
    function setUp() public {
        ...
        handler = new KodiakV3SingleTickLiquidityHandlerV3(
        ...
        positionManagerHarness = new KodiakV3SingleTickLiquidityHarnessV3(testLib, positionManager, handler);
    ...
    function testPutOptionSim() public {
        ...
        KodiakV3SingleTickLiquidityHandlerV3.TokenIdInfo memory tki =
    ...
    function testReserveLiquidity() public {
        ...
        bytes memory reserveData = abi.encode(
            KodiakV3SingleTickLiquidityHandlerV3.BurnPositionParams({
                pool: pool,
                hook: hook,
                tickLower: tickLower,
                tickUpper: tickUpper,
