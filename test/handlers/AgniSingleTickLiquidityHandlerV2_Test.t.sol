...
contract AgniSingleTickLiquidityHandlerV2_Test is Test {
    ...
    function setUp() public {
        ...
        pool = IAgniPool(agniTestLib.deployAgniPoolAndInitializePrice(ETH, LUSD, fee, initSqrtPriceX96));
    ...
    function testPutOptionSim() public {
        ...
        AgniSingleTickLiquidityHandlerV2.TokenIdInfo memory tki = pcsV3Handler.getTokenIdData(
        ...
        // console.log(agniTestLib.getCurrentSqrtPriceX96(pool));
    ...
    function testReserveLiquidity() public {
        ...
        // AgniSingleTickLiquidityHandlerV2.TokenIdInfo memory tki = pcsV3Handler
        //     .getTokenIdData(
        //         uint256(
        //             keccak256(
        //                 abi.encode(
