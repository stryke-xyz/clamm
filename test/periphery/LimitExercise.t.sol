...
contract LimitOrderTests is Test {
    ...
    function testLimitExerciseCall() public {
        ...
        LimitExercise.Order memory order = LimitExercise.Order(
            block.timestamp, 1, 5e18, block.timestamp + 20 minutes, address(token0), address(optionMarket), trader
        );
    ...
    function testFuzzMinProfit(uint256 _minProfit) public {
        ...
        LimitExercise.Order memory order = LimitExercise.Order(
            block.timestamp, 1, _minProfit, block.timestamp + 20 minutes, address(token1), address(optionMarket), trader
        );
    ...
    function testLimitExercisePut() public {
        ...
        LimitExercise.Order memory order = LimitExercise.Order(
            block.timestamp, 1, minProfit, block.timestamp + 20 minutes, address(token1), address(optionMarket), trader
        );
    ...
    function testCancelLimitExerciseOrder() public {
        ...
        LimitExercise.Order memory order = LimitExercise.Order(
            block.timestamp, 1, 0.05 ether, block.timestamp + 20 minutes, address(token1), address(optionMarket), trader
        );
