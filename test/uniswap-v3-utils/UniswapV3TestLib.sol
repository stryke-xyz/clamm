...
contract UniswapV3TestLib is Test, UniswapV3FactoryDeployer {
    IUniswapV3Factory public immutable factory;
    UniswapV3LiquidityManagement public immutable uniswapV3LiquidityManagement;
    ...
    constructor() {
        ...
        uniswapV3LiquidityManagement = new UniswapV3LiquidityManagement(
            address(factory)
        );
        swapRouter = new SwapRouter(address(factory), address(0x0));
    }

    function deployUniswapV3PoolAndInitializePrice(
        address token0,
        address token1,
        uint24 fee,
    ...
    function addLiquidity(
        ...
        token0.approve(
            address(uniswapV3LiquidityManagement),
            type(uint256).max
        );
        token1.approve(
            address(uniswapV3LiquidityManagement),
        ...
        (liquidity, , , ) = uniswapV3LiquidityManagement.addLiquidity(
